...
import { swaggerDocsIcon } from './swagger-ui/icon';
...
async function bootstrap() {
  ...
  //* cookie parser digunakan untuk mengkonversi cookie yang datang dari request menjadi object
  ...
  SwaggerModule.setup('api', app, document, {
    customSiteTitle: 'Lite Note API | Docs',
    customfavIcon: swaggerDocsIcon,
  });
